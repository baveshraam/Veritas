...
const KN: Record<string, string> = {
  ...
  // ---- Start-here openers (20 capabilities, ChatPane.OPENERS) ------------
  "New chat": "ಹೊಸ ಸಂಭಾಷಣೆ",
  "Start a new conversation — the current one stays in Previous chats":
    "ಹೊಸ ಸಂಭಾಷಣೆ ಆರಂಭಿಸಿ — ಪ್ರಸ್ತುತದ್ದು ಹಿಂದಿನ ಚಾಟ್‌ಗಳಲ್ಲಿ ಉಳಿಯುತ್ತದೆ",
  "Where crime is, and where it is going": "ಅಪರಾಧ ಎಲ್ಲಿದೆ, ಮತ್ತು ಎತ್ತ ಸಾಗುತ್ತಿದೆ",
  "Who, reconstructed across cases": "ಯಾರು — ಪ್ರಕರಣಗಳಾದ್ಯಂತ ಪುನಾರಚಿಸಲಾಗಿದೆ",
  "The analytical layers": "ವಿಶ್ಲೇಷಣಾ ಪದರಗಳು",
  "The record layer, searched the way it is searched":
    "ದಾಖಲೆ ಪದರ, ನಿಜವಾಗಿ ಹುಡುಕುವ ರೀತಿಯಲ್ಲಿ",
  "Crime hotspots": "ಅಪರಾಧ ಹಾಟ್‌ಸ್ಪಾಟ್‌ಗಳು",
  "Where are the crime hotspots right now?": "ಈಗ ಅಪರಾಧ ಹಾಟ್‌ಸ್ಪಾಟ್‌ಗಳು ಎಲ್ಲಿವೆ?",
  "Volume forecast": "ಪ್ರಮಾಣ ಮುನ್ಸೂಚನೆ",
  "Forecast case volume for the next 30 days": "ಮುಂದಿನ 30 ದಿನಗಳ ಪ್ರಕರಣ ಪ್ರಮಾಣವನ್ನು ಮುನ್ಸೂಚಿಸಿ",
  "District ranking": "ಜಿಲ್ಲಾ ಶ್ರೇಣಿ",
  "Which districts have the highest crime rates?": "ಯಾವ ಜಿಲ್ಲೆಗಳಲ್ಲಿ ಅಪರಾಧ ಪ್ರಮಾಣ ಅತ್ಯಧಿಕ?",
  "Offence mix": "ಅಪರಾಧ ಸಂಯೋಜನೆ",
  "What are the most common offences in the state?": "ರಾಜ್ಯದಲ್ಲಿ ಅತ್ಯಂತ ಸಾಮಾನ್ಯ ಅಪರಾಧಗಳು ಯಾವುವು?",
  "Case outcomes": "ಪ್ರಕರಣದ ಫಲಿತಾಂಶಗಳು",
  "How are cases split by status?": "ಸ್ಥಿತಿಯ ಪ್ರಕಾರ ಪ್ರಕರಣಗಳ ವಿಂಗಡಣೆ ಹೇಗಿದೆ?",
  "Who are the most prolific repeat offenders?": "ಅತ್ಯಧಿಕ ಪುನರಾವರ್ತಿತ ಅಪರಾಧಿಗಳು ಯಾರು?",
  "Offenders by district": "ಜಿಲ್ಲಾವಾರು ಅಪರಾಧಿಗಳು",
  "Top offenders in Mysuru": "ಮೈಸೂರಿನ ಪ್ರಮುಖ ಅಪರಾಧಿಗಳು",
  "Criminal network": "ಅಪರಾಧ ಜಾಲ",
  "Who is in community 1?": "ಸಮುದಾಯ 1 ರಲ್ಲಿ ಯಾರಿದ್ದಾರೆ?",
  "District profile": "ಜಿಲ್ಲಾ ಪ್ರೊಫೈಲ್",
  "Give me a district profile of Kolar": "ಕೋಲಾರ ಜಿಲ್ಲೆಯ ಪ್ರೊಫೈಲ್ ನೀಡಿ",
  "Causal analysis": "ಕಾರಣ ವಿಶ್ಲೇಷಣೆ",
  "Is there a link between poverty and crime rates?": "ಬಡತನ ಮತ್ತು ಅಪರಾಧ ಪ್ರಮಾಣದ ನಡುವೆ ಸಂಬಂಧವಿದೆಯೇ?",
  "Station workload": "ಠಾಣೆಯ ಕೆಲಸದ ಹೊರೆ",
  "Which stations need help with their backlog?": "ಯಾವ ಠಾಣೆಗಳಿಗೆ ಬಾಕಿ ಪ್ರಕರಣಗಳಲ್ಲಿ ನೆರವು ಬೇಕು?",
  "Stalled cases": "ಸ್ಥಗಿತಗೊಂಡ ಪ್ರಕರಣಗಳು",
  "Which cases have gone cold?": "ಯಾವ ಪ್ರಕರಣಗಳು ಸ್ಥಗಿತಗೊಂಡಿವೆ?",
  "Financial watchlist": "ಆರ್ಥಿಕ ನಿಗಾ ಪಟ್ಟಿ",
  "Show me the AML watchlist": "AML ನಿಗಾ ಪಟ್ಟಿಯನ್ನು ತೋರಿಸಿ",
  "Filtered search": "ಶೋಧಕ ಹುಡುಕಾಟ",
  "List theft cases in Mysuru that are still under investigation":
    "ಮೈಸೂರಿನಲ್ಲಿ ಇನ್ನೂ ತನಿಖೆಯಲ್ಲಿರುವ ಕಳ್ಳತನ ಪ್ರಕರಣಗಳನ್ನು ಪಟ್ಟಿ ಮಾಡಿ",
  "Search by section": "ಕಲಂ ಮೂಲಕ ಹುಡುಕಿ",
  "Show me cases under section 379": "ಕಲಂ 379 ರ ಅಡಿಯ ಪ್ರಕರಣಗಳನ್ನು ತೋರಿಸಿ",
  "Search by method": "ವಿಧಾನದ ಮೂಲಕ ಹುಡುಕಿ",
  "Find cases involving chain snatching near a bus stand":
    "ಬಸ್ ನಿಲ್ದಾಣದ ಬಳಿ ಸರಗಳ್ಳತನ ಸಂಬಂಧಿತ ಪ್ರಕರಣಗಳನ್ನು ಹುಡುಕಿ",
  "Recent filings": "ಇತ್ತೀಚಿನ ದಾಖಲಾತಿಗಳು",
  "Show me cases filed in the last 6 months": "ಕಳೆದ 6 ತಿಂಗಳಲ್ಲಿ ದಾಖಲಾದ ಪ್ರಕರಣಗಳನ್ನು ತೋರಿಸಿ",
  "Search by station": "ಠಾಣೆಯ ಮೂಲಕ ಹುಡುಕಿ",
  "Show me cases from police station 2304": "ಪೊಲೀಸ್ ಠಾಣೆ 2304 ರ ಪ್ರಕರಣಗಳನ್ನು ತೋರಿಸಿ",
  "Search by outcome": "ಫಲಿತಾಂಶದ ಮೂಲಕ ಹುಡುಕಿ",
  "Show me murder cases that ended in acquittal": "ಖುಲಾಸೆಯಲ್ಲಿ ಕೊನೆಗೊಂಡ ಕೊಲೆ ಪ್ರಕರಣಗಳನ್ನು ತೋರಿಸಿ",
  "Ask in Kannada": "ಕನ್ನಡದಲ್ಲಿ ಕೇಳಿ",
